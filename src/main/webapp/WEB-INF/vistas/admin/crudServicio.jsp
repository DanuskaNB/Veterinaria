...
<h4>Mantener Servicio | Entre Patas</h4>
					<div class="row my-2" >
			...
			<div class="modal-dialog">
				...
				<div class="modal-body">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraCrudServicio" method="post" enctype="multipart/form-data">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-form-label" for="id_reg_horario">Horario</label>
													<input class="form-control" id="id_reg_horario" name="horario" placeholder="Ingrese el Horario" type="text" maxlength="20"/>
		                                    </div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-body">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="actualizaCrudProducto"  method="post" enctype="multipart/form-data">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-form-label" for="id_act_horario">Horario</label>
													<input class="form-control" id="id_act_horario" name="horario" placeholder="Ingrese el Horario" type="text" maxlength="20"/>
		                                    </div>
