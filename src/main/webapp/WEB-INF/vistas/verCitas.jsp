...
<h4>Consulta tu Cita</h4>
	 	 ...
	 	 <div class="modal fade " id="modal_registra" >
			...
			<form id="id_form_registra" accept-charset="UTF-8" action="registraCita" method="post">
		...
		<div class="col-md-10" style="margin:0 10%;" > 
...
function listarCitas(){
	fetch('listarCitaCliente?filtro2='+`${sessionScope.objUsuario.idCliente}`)
